...
abstract public class AbstractSkipList {
    ...
    public void increaseHeight() {
        ...
        head.size++; // Increase size when height is increased
    ...
    public boolean delete(SkipListNode skipListNode) {
        ...
        SkipListNode prevNode = skipListNode.getPrev(0);
        while (prevNode != null) {
            prevNode.size--; // Decrement size
            prevNode = prevNode.getPrev(0);
        }
        return true;
    }
